...
import io.github.stevenbenmoha.stillmind.R;
...
public class FButton extends AppCompatButton implements View.OnTouchListener {
    ...
    private void init() {
        ...
        mButtonColor = resources.getColor(R.color.fbutton_color_stillmind);
        mShadowColor = resources.getColor(R.color.fbutton_color_stillmind_shadow);
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.FButton_shadowEnabled) {
                ...
                mButtonColor = typedArray.getColor(attr, getResources().getColor(R.color.fbutton_color_stillmind));
            } else if (attr == R.styleable.FButton_shadowColor) {
                mShadowColor = typedArray.getColor(attr, getResources().getColor(R.color.fbutton_color_stillmind_shadow));
                ...
                mCornerRadius = typedArray.getDimensionPixelSize(attr, getResources().getDimensionPixelSize(R.dimen.fbutton_default_conner_radius));
            }
        }
        typedArray.recycle();
